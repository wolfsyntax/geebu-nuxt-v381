  ...
  <div>
        ...
        <div v-if="showOnboardingMessage">
          ...
          <div class="modal">
            <div class="modal-content">
              ...
              <p class="description">
                Welcome to Geebu! We're thrilled to have you on board. Get ready to embark on an exciting journey of Music and Events, and explore a world of possibilities. 
                Whether you're a seasoned user or just starting out, we're here to support you every step of the way. Let's dive in and make the most of your experience with Geebu together!"
              </p>
        ...
        <div class="onboarding-message" v-if="showOnboardingMessage">
          ...
          <div class="modal">
            <div class="modal-content">
              <h2 class="title">Welcome Aboard!</h2>
              <p class="description">
                In order to access the full range of features within the app, it is necessary to subscribe to the artist plan. 
                You can still browse the app and explore its interface, but your access to certain features will be limited until you upgrade to the subscription.
              </p>
          ...
          <div class="carousel-inner">
            ...
            <div class="carousel-item">
              ...
              <div class="carousel-caption d-none d-md-block">
                ...
                <p>We offer a wide range of equipment rental options, including sound systems, lighting, staging, and more.</p>
                <div v-if="isLoggedIn">
            ...
            <div class="carousel-item">
              ...
              <div class="carousel-caption d-none d-md-block content-4">
                <h3>No worries if you're unsure how to create an event - we've got you covered! Come and easily create your own event with us today.</h3>
                <p>
                  We offer a wide range of equipment rental options, including sound systems, lighting, staging, and more.
                </p>
                <div v-if="isLoggedIn">
    ...
    <section class="geebu-presentation">
      <div class="container">
        <div class="row">
          ...
          <div class="col-6">
            <p class="content">
              Experience the Ultimate Fusion of Creativity and Entertainment with Geebu Create Your Custom Song, Tailored Exclusively for Your Special Event or Party. 
              Connect with Talented Artists Ready to Elevate Your Celebrations to Unforgettable Heights.
              Get Started Today and Let the Music Speak the Language of Your Joy!"
            </p>
          ...
          <div class="col-6">
            <div class="video-container">
              <video width="778" height="440.693" ref="videoPlayer" @click="togglePresentationVideo" :poster=videoThumbnail>
        ...
        <div class="row">
          <div id="custom-song-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
            <div class="carousel-indicators">
              <button type="button" data-bs-target="#custom-song-carousel" data-bs-slide-to="0" 
                class="active" aria-current="true" aria-label="Slide 1"
              >
                <span class="number1">1</span>
              </button>
              <button type="button" data-bs-target="#custom-song-carousel" data-bs-slide-to="1" aria-label="Slide 2">
                <span class="number2">2</span>
              </button>
              <button type="button" data-bs-target="#custom-song-carousel" data-bs-slide-to="2" aria-label="Slide 3">
                ...
                <div class="row">
                  <div class="col-lg-6 col-xl-5 col-xxl-5">
                    <div class="carousel-caption d-none d-md-block step1">
                      ...
                      <p>
                        Tell us who the song is for or what it’s all about. 
                        Artist just need a little inspiration to make it truly custom and unique.
                      </p>
                      <a href="/create-song" class="btn btn-primary btn-lg">Create your song</a>
                    </div>
                  </div>
                ...
                <div class="row">
                  <div class="col-lg-6 col-xl-5 col-xxl-5">
                    <div class="carousel-caption d-none d-md-block step2">
                      ...
                      <p>
                        Select the artist you want. Then pick your preffered genre, tempo, and mood so that they can get started.
                      </p>
    ...
    <section class="discover-artist">
      <div class="container">
        ...
        <p class="sub-heading">Lorem ipsum dolor sit amet consectetur. Hac vulputate ut adipiscing diam malesuada ultrices id.</p>
          ...
          <div class="row available-artist">
            <div class="col-lg-6 col-xl-6 col-xxl-6">
              <div class="content">
                ...
                <p>Our platform allows you to choose from a wide selection of available artists who are ready to make your event unforgettable.</p>
            ...
            <div class="col-lg-6 col-xl-6 col-xxl-6">
              <div id="availableArtist" class="carousel slide" data-bs-ride="carousel" data-bs-interval="5000">
                <div class="carousel-indicators">
                  <button type="button" data-bs-target="#availableArtist" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1"></button>
                  <button type="button" data-bs-target="#availableArtist" data-bs-slide-to="1" aria-label="Slide 2"></button>
                  <button type="button" data-bs-target="#availableArtist" data-bs-slide-to="2" aria-label="Slide 3"></button>
                </div>

                <div class="carousel-inner">
                  <div class="carousel-item active">
                    <img src="/assets/home/available-artist-slider-1.webp" 
                      class="d-block w-100" loading="lazy" alt="Choose available artist"
                    >
                  </div>

                  <div class="carousel-item">
                    <img src="/assets/home/available-artist-slider-2.webp" 
                      class="d-block w-100" loading="lazy" alt="Choose available artist"
                    >
                  </div>

                  <div class="carousel-item">
                    <img src="/assets/home/available-artist-slider-3.webp" 
                      class="d-block w-100" loading="lazy" alt="Choose available artist"
                    >
                  </div>
                </div>
          ...
          <div class="row book-your-event">
            <div class="col-lg-6 col-xl-6 col-xxl-6">
              <div id="bookYourEvent" class="carousel slide" data-bs-ride="carousel" data-bs-interval="5000">
                <div class="carousel-indicators">
                  <button type="button" data-bs-target="#bookYourEvent" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1"></button>
                  <button type="button" data-bs-target="#bookYourEvent" data-bs-slide-to="1" aria-label="Slide 2"></button>
                  <button type="button" data-bs-target="#bookYourEvent" data-bs-slide-to="2" aria-label="Slide 3"></button>
                </div>

                <div class="carousel-inner">
                  <div class="carousel-item active">
                    <img src="/assets/home/book-event-slider-1.webp" class="d-block w-100" loading="lazy" alt="Choose available artist">
                  </div>

                  <div class="carousel-item">
                    <img src="/assets/home/book-event-slider-2.webp" class="d-block w-100" loading="lazy" alt="Choose available artist">
                  </div>

                  <div class="carousel-item">
                    <img src="/assets/home/book-event-slider-3.webp" class="d-block w-100" loading="lazy" alt="Choose available artist">
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-6 col-xl-6 col-xxl-6">
              <div class="content">
                ...
                <p>
                  With our platform, you can easily set and book your event, ensuring that everything runs smoothly from start to finish.
                </p>
    ...
    <section class="songs-for-occasion">
      <div class="container">
        ...
        <p class="sub-heading">Lorem ipsum dolor sit amet consectetur. Hac vulputate ut adipiscing diam malesuada ultrices id.</p>
        <div class="row">
          <div class="col-4" v-for="(occasion,index) in occasions" :key="index">
            <songs-occasion :occasion=occasion />
          </div>
        </div>

        <div class="button-wrapper">
          <nuxt-link to="/events" class="btn btn-primary btn-lg" >See All Occasion</nuxt-link>
        </div>
      </div>
    </section>
    ...
    <section class="testimonials">
      <div class="container">
        ...
        <p class="sub-heading">
          Lorem ipsum dolor sit amet consectetur. Hac vulputate ut adipiscing diam malesuada ultrices id.
        </p>
        ...
        <div id="testimonialsSlider" class="carousel slide" data-bs-ride="carousel" data-bs-interval="500000">
          <ol class="carousel-indicators">
            <li v-for="(review, index) in reviews" :key="index" data-bs-target="#testimonialsSlider"
              :data-bs-slide-to="index" :class="{ 'active': index === activeIndex }" @click="changeVideo(index)">
            </li>
          </ol>

          <div class="carousel-inner">
            <div v-for="(review, index) in reviews" :key="index" :class="['carousel-item', { 'active': index === activeIndex }]" data-bs-interval="500000">
              <div class="row">
                <div class="col-6">
                  <div class="video-container">
                    <div class="video">
